...
class _WorldNewsState extends State<WorldNews> {
  ...
  getWorldNews(bool firstTime, String category) {
    var provider = Provider.of<PostProvider>(context, listen: false);
    if (!provider.getWorldNewsFechingStatus() && firstTime == true) {
      provider.getWorldNewsFromDB(context, category);
      provider.setWorldNewsFechingStatus(true);
    }
    else if (provider.getWorldNewsFechingStatus() && firstTime == false) {
      provider.getWorldNewsFromDB(context, category);
        ...
        child: ListView(
          ...
          children: [
                                  ...
                                  onTap: () {
                                    chooseCategory(
                                        ...
                                        postProvider
                                            ...
                                            .id);
                                    getWorldNews(false, category.categoryName!);
                                  },
                                  child: Container(
                                      padding: const EdgeInsets.symmetric(
            ...
            ListView.builder(
                ...
                itemCount: postProvider.getWorldNews().length,
                itemBuilder: (context, index) {
                  var post = postProvider.getWorldNews()[index];
                  return CustomAnimatedList(
                    index: index,
